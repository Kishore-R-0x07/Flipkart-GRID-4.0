...
class ArucoSingleTracker():
    def __init__(self,
        ...
        #self._cap.release()
        self.out = cv2.VideoWriter('lib_aruco.mp4',self.fourcc, 20.0, (camera_size[0], camera_size[1]))
        ...
        #-- self.font for the text in the image
...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=id_to_find, marker_size=marker_size, show_video=True, store_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
