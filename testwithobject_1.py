...
aruco_tracker       = ArucoSingleTracker(id_to_find=id_to_find, marker_size=marker_size, show_video=False, store_video=True, 
...
while True:                
    ...
    if marker_found:
        ...
        if time.time() >= time_0 + 1.0/freq_send and not picking:
            ...
            vehicle.simple_goto(location_marker, groundspeed = 0.75)
